...
const models = [
  ...
  { name: 'GPT-4o', provider: 'Puter.js', tier: 'Premium', color: 'var(--orange)' },
  { name: 'Claude Sonnet', provider: 'Puter.js', tier: 'Premium', color: 'var(--orange)' },
  { name: 'DeepSeek R1', provider: 'Puter.js', tier: 'Premium', color: 'var(--orange)' },
  { name: 'GPT-OSS 120B', provider: 'Cloudflare', tier: 'Premium', color: 'var(--cyan)' },
  { name: 'Llama 4 Scout', provider: 'Cloudflare', tier: 'Premium', color: 'var(--cyan)' },
  { name: 'Gemma 4 26B', provider: 'Cloudflare', tier: 'Premium', color: 'var(--cyan)' },
  { name: 'Nemotron 3 120B', provider: 'Cloudflare', tier: 'Premium', color: 'var(--cyan)' },
  { name: 'FLUX.2 Dev', provider: 'Cloudflare', tier: 'Premium', color: 'var(--cyan)' },
]
