...
const capabilities = [
  ...
  { icon: Brain, label: '39+ Modelos', desc: 'GPT-5, Claude, Gemini, Llama, DeepSeek', color: 'var(--red)' },
]

const models = [
  { name: 'GPT-4o Mini', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'GPT-4o', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'GPT-4.1', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'o4-mini', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'GPT-5 Nano', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'GPT-5 Mini', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'GPT-5', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'Claude Sonnet', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'Gemini 2.5 Flash', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'Gemini 2.5 Pro', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'DeepSeek R1', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'DeepSeek V3', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'Llama 3.3 70B', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'Llama 4 Scout', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'Llama 4 Maverick', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'Mistral Large', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'Codestral', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'Phi-4', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'Command A', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'Nemotron 70B', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'Jamba 1.5', provider: 'GitHub AI', tier: 'Free', color: 'var(--green)' },
  { name: 'GPT-OSS 120B', provider: 'Cloudflare', tier: 'Free', color: 'var(--cyan)' },
  { name: 'Llama 4 Scout CF', provider: 'Cloudflare', tier: 'Free', color: 'var(--cyan)' },
  { name: 'DeepSeek R1 32B', provider: 'Cloudflare', tier: 'Free', color: 'var(--cyan)' },
  { name: 'Gemma 4 26B', provider: 'Cloudflare', tier: 'Free', color: 'var(--cyan)' },
  { name: 'FLUX.2 Dev', provider: 'Cloudflare', tier: 'Free', color: 'var(--cyan)' },
