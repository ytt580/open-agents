...
const plans = [
  {
    ...
    model: 'GPT-5',
    modelDesc: 'Modelo da OpenAI',
    popular: false,
    features: [
      { text: 'GPT-5 como motor de IA', included: true },
      { text: '5 agentes ativos', included: true },
      { text: '100 tarefas/mes', included: true },
      { text: 'Scraping basico', included: true },
      { text: 'Gerador de sites', included: true },
      { text: 'Email automatico', included: false },
  ...
  {
    name: 'Premium',
    tagline: 'Para quem quer resultados reais',
    price: 'R$ 97',
    period: '/mes',
    icon: Crown,
    color: 'var(--accent)',
    ...
    model: 'Kimi K3',
    modelDesc: 'Bluesminds - Mais inteligente',
    popular: true,
    features: [
      { text: 'Kimi K3 como motor de IA', included: true },
      { text: 'Agentes ilimitados', included: true },
      { text: 'Tarefas ilimitadas', included: true },
      { text: 'Scraping avancado + MCP', included: true },
      { text: 'Gerador de sites premium', included: true },
      { text: 'Email automatico', included: true },
      { text: 'WhatsApp integration', included: true },
      { text: 'API access', included: true },
      { text: 'Suporte prioritario', included: true },
      { text: 'Figma + Mobbin MCP', included: true },
    ],
    cta: 'Ativar Premium',
