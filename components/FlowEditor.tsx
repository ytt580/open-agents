...
export function FlowEditor({ flowId, flow, onBack, onSave }: FlowEditorProps) {
  ...
  const freeModels = [
    ...
    { id: 'gpt-5-nano', name: 'GPT-5 Nano', desc: 'GPT-5 rapido', free: true },
    { id: 'gpt-5-mini', name: 'GPT-5 Mini', desc: 'GPT-5 balanceado', free: true },
    { id: 'claude-sonnet-4-6', name: 'Claude Sonnet', desc: 'Analitico + visao', free: true },
    { id: 'gemini-2.5-flash', name: 'Gemini Flash', desc: 'Google rapido', free: true },
    { id: 'deepseek/deepseek-r1', name: 'DeepSeek R1', desc: 'Raciocinio', free: true },
    { id: 'deepseek/deepseek-v3-0324', name: 'DeepSeek V3', desc: 'Geral', free: true },
    { id: 'meta-llama/llama-4-maverick', name: 'Llama 4 Maverick', desc: 'Meta 128E', free: true },
    { id: 'meta-llama/llama-4-scout', name: 'Llama 4 Scout', desc: 'Meta 17B', free: true },
    { id: 'meta-llama/llama-3.3-70b', name: 'Llama 3.3 70B', desc: 'Meta geral', free: true },
    { id: 'mistralai/mistral-large-latest', name: 'Mistral Large', desc: 'Europeu', free: true },
    { id: 'cohere/command-r-plus', name: 'Command R+', desc: 'Cohere RAG', free: true },
    { id: 'ai21/jamba-1.5-large', name: 'Jamba 1.5 Large', desc: 'AI21', free: true },
  ]
