...
export function FlowEditor({ flowId, flow, onBack, onSave }: FlowEditorProps) {
  ...
  const freeModels = [
    ...
    { id: 'gemini-2.5-flash', name: 'Gemini Flash', desc: 'GitHub AI - google', free: true },
  ...
  const premiumModels = [
    ...
    { id: 'gpt-5.2-pro', name: 'GPT-5.2 Pro', desc: 'Puter.js - raciocinio', premium: true },
    ...
    { id: 'deepseek/deepseek-v4-pro', name: 'DeepSeek V4 Pro', desc: 'Puter.js - 1.6T', premium: true },
    ...
    { id: 'google/veo-3.0', name: 'Veo 3', desc: 'Puter.js - video', premium: true },
  ]
