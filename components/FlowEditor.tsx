...
export function FlowEditor({ flowId, flow, onBack, onSave }: FlowEditorProps) {
  ...
  const freeModels = [
    ...
    { id: 'cloudflare/gpt-oss-120b', name: 'GPT-OSS 120B', desc: 'Cloudflare - open source', free: true },
    { id: 'cloudflare/llama-4-scout', name: 'Llama 4 Scout CF', desc: 'Cloudflare - meta', free: true },
    { id: 'cloudflare/deepseek-r1', name: 'DeepSeek R1 32B', desc: 'Cloudflare - raciocinio', free: true },
    { id: 'cloudflare/gemma-4-26b', name: 'Gemma 4 26B', desc: 'Cloudflare - google', free: true },
    { id: 'cloudflare/mistral-small', name: 'Mistral Small 3.1', desc: 'Cloudflare - 24B', free: true },
    { id: 'cloudflare/nemotron-3-120b', name: 'Nemotron 3 120B', desc: 'Cloudflare - NVIDIA', free: true },
    { id: 'cloudflare/kimi-k2.7', name: 'Kimi K2.7 Code', desc: 'Cloudflare - moonshot', free: true },
    { id: 'cloudflare/qwq-32b', name: 'QwQ 32B', desc: 'Cloudflare - Qwen raciocinio', free: true },
    { id: 'cloudflare/flux-2-dev', name: 'FLUX.2 Dev', desc: 'Cloudflare - imagem', free: true },
  ]

  const premiumModels = [
    { id: 'gpt-5.3-codex', name: 'GPT-5.3 Codex', desc: 'Puter.js - codificacao', premium: true },
    { id: 'gpt-5.2', name: 'GPT-5.2', desc: 'Puter.js - trabalho', premium: true },
    { id: 'claude-opus-4-8', name: 'Claude Opus', desc: 'Puter.js - premium', premium: true },
    { id: 'grok-3', name: 'Grok 3', desc: 'Puter.js - xAI', premium: true },
    { id: 'gemini-3.1-pro', name: 'Gemini 3.1 Pro', desc: 'Puter.js - google', premium: true },
    { id: 'kwaivgi/kling-2.1-master', name: 'Kling 2.1 Master', desc: 'Puter.js - video', premium: true },
    { id: 'google/imagen-4.0', name: 'Imagen 4', desc: 'Puter.js - imagem', premium: true },
  ]
